    ...
    <>
      <div className=" pt-[5px] pl-[10px]">
        ...
        {!userInfo.email || !userInfo.password ? 
          ...
          :
          <i className="fa-solid fa-right-from-bracket float-right text-[1.75rem] pt-[10px] cursor-pointer text-white pr-[1rem] hover:text-[#c4bfbf] " onClick={()=>handleLogout()}></i>
        }
